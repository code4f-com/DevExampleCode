...
//    }
   ...
   */
    public boolean equals(Object obj){
        ...
        if (obj instanceof com.tuanpla.utils.Date){
            return ((com.tuanpla.utils.Date) obj).getDate().equals(currDate);
        }
            ...
            try{
                return new com.tuanpla.utils.Date((String) obj).equals(currDate);
            }
            catch(ParseException e){}
        }
        return false;
   ...
   *  months, years, etc.)
   */    
    public long compareTo(com.tuanpla.utils.Date date, String units){
  ...
  /**  Implements compareTo public members */
    ...
    public boolean isBefore(String date) throws ParseException {
        return isBefore(new com.tuanpla.utils.Date(date));
    }
    
    public boolean isBefore(com.tuanpla.utils.Date Date){
        return currDate.before(Date.getDate());
    }

    public boolean isAfter(String date) throws ParseException {
        return isAfter(new com.tuanpla.utils.Date(date));
    }
    
    public boolean isAfter(com.tuanpla.utils.Date Date){
   ...
   */
    ...
    private com.tuanpla.utils.Date getShortDate(){
        try{
            java.util.TimeZone tz = getTimeZone();
            com.tuanpla.utils.Date date = new com.tuanpla.utils.Date(toString("MM/dd/yyyy"));
   ...
   */
    private static class DateComparer implements java.util.Comparator {
        ...
        public final int compare(Object a, Object b){
            ...
            else if (a instanceof com.tuanpla.utils.Date) d1 = ((com.tuanpla.utils.Date) a).getDate();

            if (b instanceof java.util.Date) d2 = ((java.util.Date) b);
            else if (b instanceof com.tuanpla.utils.Date) d2 = ((com.tuanpla.utils.Date) b).getDate();
        ...
        for (String id : java.util.TimeZone.getAvailableIDs()){
          ...
          //Add GMT offset
            ...
            String gmt =
                    ...
                    String.format("%02d", (int) com.tuanpla.utils.string.round(m, 0));
