...
public class MemcachedClient {
            ...
            while (true) {
                ...
                if (line.startsWith(VALUE)) {
                    ...
                    if ((flag & F_COMPRESSED) == F_COMPRESSED) {
                        try {
                            try ( // read the input stream, and write to a byte array output stream since
    ...
    public Map<String, Object> getMulti(String[] keys, Integer[] hashCodes, boolean asString) {
        ...
        Map<String, StringBuilder> cmdMap = new HashMap<>();
        ...
        // now query memcache
        Map<String, Object> ret = new HashMap<>(keys.length);
    ...
    private Map stats(String[] servers, String command, String lineStart) {
        ...
        // array of stats Maps
        Map<String, Map> statsMaps = new HashMap<>();
