...
public class SockIOPool {
    ...
    protected SockIO createSocket(String host) {
        ...
        try {
            if (socket == null) {
                ...
                long expire = (hostDeadDur.containsKey(host)) ? ((hostDeadDur.get(host)) * 2) : 1000;
    ...
    public SockIO getSock(String key, Integer hashCode) {
        ...
        Set<String> tryServers = new HashSet<>(Arrays.asList(servers));
    ...
    protected void selfMaint() {
        ...
        synchronized (this) {
            ...
            for (String host : availPool.keySet()) {
        ...
        for (String host : needSockets.keySet()) {
            ...
            Set<SockIO> newSock = new HashSet<>(need);
        ...
        synchronized (this) {
            ...
            // as needed to maintain pool settings
            for (String host : busyPool.keySet()) {
