...
public class Form {
   ...
   */
    public com.tuanpla.javaxt.http.Response submit(){
      ...
      //Convert the form inputs into a request
        ...
        com.tuanpla.javaxt.http.Request request = null;
        if (method.equalsIgnoreCase("post")){

          //Instantiate HTTP request
            request = new com.tuanpla.javaxt.http.Request(action);
          ...
          //Send the http request
            ...
            com.tuanpla.utils.URL url = new com.tuanpla.utils.URL(action);
            payload.append("&" + url.getQueryString());
            url.setQueryString(url.getQueryString() + "&" + payload.toString());
            request = new com.tuanpla.javaxt.http.Request(url.toString());
        }
