package com.tuanpla.javaxt.webservices;
import org.w3c.dom.*;
import com.tuanpla.javaxt.xml.DOM;
import com.tuanpla.utils.Value;
    ...
    private Object getValue(Object val){
        if (type.equalsIgnoreCase("base64Binary")){
            if (val instanceof byte[]){
                ...
                return com.tuanpla.utils.Base64.decode((String) val);
            }
            else if (val instanceof java.io.File){
                return new com.tuanpla.javaxt.io.File((java.io.File) val).getBytes().toByteArray();
            }
            else if (val instanceof com.tuanpla.javaxt.io.File){
                return ((com.tuanpla.javaxt.io.File) val).getBytes().toByteArray();
            }
        }
            ...
            else if (val instanceof com.tuanpla.utils.Date){
                return ((com.tuanpla.utils.Date) val).getDate();
            }
            else if (val instanceof String){
                try{ return new com.tuanpla.utils.Date((String) val).getDate(); }
                catch(Exception e){}
            }
        }
    ...
    protected String toXML(String attributes){
        ...
        if (value!=null && value.getClass().isArray()){
            ...
            if (value instanceof byte[]){
                ...
                xml.append(com.tuanpla.utils.Base64.encodeBytes((byte[]) value));
                xml.append("</" + name + ">");
            }
                ...
                for (Object obj : (Object[]) value){
                    String val = obj + "";
                    if (escapeXML) val = com.tuanpla.javaxt.xml.DOM.escapeXml(val);
            ...
            if (value instanceof String){
                if (!isComplex()){
                    ...
                    xml.append(com.tuanpla.javaxt.xml.DOM.escapeXml((String) value));
                }
                else{ //xml fragment?
...
//    }
    ...
    private int cint(String str){
        return com.tuanpla.utils.string.cint(str);
    }
