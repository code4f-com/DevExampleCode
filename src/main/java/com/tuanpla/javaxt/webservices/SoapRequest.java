...
public class SoapRequest {
    ...
    private com.tuanpla.javaxt.http.Request request;
  ...
  /** Creates a new instance of SoapRequest. */
    ...
    public SoapRequest(Service service, Method method, Object parameters) {
      ...
      //Create new http request
        request = new com.tuanpla.javaxt.http.Request(service.getURL());
                ...
                if (parameters instanceof Parameter){
                    ...
                    if (params!=null){
                        for (int i=0; i<params.length; i++ ) {
                             ...
                             body.append("<" + parameterName + ">" + com.tuanpla.javaxt.xml.DOM.escapeXml(parameterValue) + "</" + parameterName + ">");
                        }
                    }
                }
            }
