...
public class SoapResponse {
   ...
   */
    protected SoapResponse(com.tuanpla.javaxt.http.Response response, String resultsNode) throws SoapException {
   ...
   */
    public byte[] toByteArray(){
        return com.tuanpla.utils.Base64.decode(message.trim());
    }
   ...
   */
    public com.tuanpla.javaxt.io.Image toImage(){
        return new com.tuanpla.javaxt.io.Image(toByteArray());
    }
