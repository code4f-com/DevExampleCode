...
public class SoapException extends Exception {
  ...
  /** Creates a new instance of SoapException. */
    ...
    private static String getErrorMessage(String message, String serverResponse){
        org.w3c.dom.Document xml = com.tuanpla.javaxt.xml.DOM.createDocument(serverResponse);
        if (xml!=null){
            org.w3c.dom.Node[] faultstrings = com.tuanpla.javaxt.xml.DOM.getElementsByTagName("faultstring", xml);
