...
public class HttpServletRequest {
          ...
          //If this is the first byte, check whether the request is SSL
            if (totalBytesRead==1 && ((a>19 && a<25) || a==-128)){
              ...
              //connection. Create a new SSLEngine as needed.
                ...
                if (sslEngine==null){
                    sslEngine = servlet.getSSLEngine();
   ...
   */
    private void initHandshake() throws ServletException,
        IOException {
        ...
        while (!isEngineClosed(sslEngine)) {
          ...
          //Read new bytes from the socket
            if (serverResult!=null){
                inNetData.clear();
                inNetDataLength = read(inNetData);
                inNetData.rewind();
            }
   ...
   */
    ...
    private void log(String str) {
        if (debug) synchronized(System.out) { System.out.println(str); }
    }
