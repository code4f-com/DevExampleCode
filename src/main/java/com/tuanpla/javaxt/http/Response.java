...
public class Response {
   ...
   */
    public org.w3c.dom.Document getXML(){
        return com.tuanpla.javaxt.xml.DOM.createDocument(new ByteArrayInputStream(getBytes(true).toByteArray()));
    }
   ...
   */
    public com.tuanpla.javaxt.io.Image getImage(){
        return new com.tuanpla.javaxt.io.Image(getBytes(true).toByteArray());
    }
