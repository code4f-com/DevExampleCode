...
public class Image {
   ...
   *   position. This method can also be used to create image mosiacs.
   */    
    public void addImage(com.tuanpla.javaxt.io.Image in, int x, int y, boolean expand){ 
...
//            encoder.encode(bi, params);
   ...
   */
    public boolean equals(Object obj){
        if (obj!=null){
            if (obj instanceof com.tuanpla.javaxt.io.Image){
                com.tuanpla.javaxt.io.Image image = (com.tuanpla.javaxt.io.Image) obj;
...
private class Skew {
    ...
    public Skew(com.tuanpla.javaxt.io.Image src) {
