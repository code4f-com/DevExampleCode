...
public class File implements Comparable {
  ...
  /**  Used to move the file to a different directory. */
    ...
    public com.tuanpla.javaxt.io.File moveTo(Directory Destination){
        java.io.File File = getFile();
   ...
   *  successfully.
   */
    public boolean copyTo(com.tuanpla.javaxt.io.File Destination, boolean Overwrite){
   ...
   */
    public com.tuanpla.javaxt.io.File rename(String FileName){
        if (FileName!=null){
   ...
   */
    public org.w3c.dom.Document getXML(){
        ...
        try{
            is = getInputStream();
            org.w3c.dom.Document xml = com.tuanpla.javaxt.xml.DOM.createDocument(is);
            is.close();
            return xml;
        }
        catch(Exception e){
   ...
   */
    public void write(org.w3c.dom.Document xml){
        write(com.tuanpla.javaxt.xml.DOM.getText(xml), xml.getXmlEncoding());
    }
  ...
  //**************************************************************************
    ...
    public boolean equals(Object obj){
        if (obj instanceof com.tuanpla.javaxt.io.File || obj instanceof java.io.File){
        ...
        if (isWindows){
            ...
            if (dllLoaded==null){ //haven't tried to load the dll yet...
              ...
              //Construct list of possible file locations for the dll
                ...
                com.tuanpla.javaxt.io.Directory dir = new com.tuanpla.javaxt.io.Directory(System.getProperty("user.home"));
                for (String appDir : new String[]{"AppData\\Local", "Application Data"}){
                    com.tuanpla.javaxt.io.Directory d = new com.tuanpla.javaxt.io.Directory(dir + appDir);
            ...
            if (line!=null){
                ...
                if (arr.length>7){
                    try{
                        ...
                        return new com.tuanpla.utils.Date(date, "yyyy-MM-dd HH:mm:ss z").getDate();
                    }
                    catch(Exception e){
                    }
                }
            ...
            if (line!=null){
                ...
                if (arr.length>10){
                    try{
                        ...
                        return new com.tuanpla.utils.Date(date, "MMM dd hh:mm:ss yyyy").getDate();
                    }
                    catch(Exception e){
                    }
                }
