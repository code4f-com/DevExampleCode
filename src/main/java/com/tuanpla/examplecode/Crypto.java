...
public class Crypto {
    ...
    public void setupEncrypt() throws NoSuchAlgorithmException,
        ...
        rnd.nextBytes(mSalt);
        Db("generated salt :" + encodeHexString(mSalt));
        ...
        Db("mInitVec is :" + encodeHexString(mInitVec));
    }
    ...
    public void setupDecrypt(String initvec, String salt) throws NoSuchAlgorithmException,
        ...
        Db("got salt " + encodeHexString(mSalt));

        // get initialization vector from passed string
        mInitVec = Hex.decodeHex(initvec.toCharArray());
        Db("got initvector :" + encodeHexString(mInitVec));
...
//            }
    ...
    public static void main(String[] args) {
        ...
        String iv = null;
        String salt = null;
        Crypto en = new Crypto("mypassword12312");
        ...
        try {
            ...
            en.setupEncrypt();
            iv = encodeHexString(en.getInitVec()).toUpperCase();
            salt = encodeHexString(en.getSalt()).toUpperCase();
         ...
         * decrypt file
         */
        Crypto dc = new Crypto("mypassword12312");
        try {
